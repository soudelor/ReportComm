...
#define BARCODE_ONLY_CHECKSUM 0x00000400   /* Output only checksum */

#define BARCODE_OUTPUT_MASK   0x000ff000   /* 256 output types */
#define BARCODE_OUT_PS        0x00002000
#define BARCODE_OUT_CHECKSUM  0x00003000
...
extern int FromBarcodeStringToID(const char *barname);
/*
